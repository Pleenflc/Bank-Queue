...
try {
    $stmt = $pdo->query("SELECT * FROM mobile_queue ORDER BY time_created DESC");
...
<div class="container">
  <div class="row g-4 align-items-start">
    <div class="col-md-6 left-info">
      ...
      <p>Services typically provided by our Mobile Banking Team include:</p>
      <ul>
        <li>Mobile banking registration and activation</li>
        <li>Troubleshooting login or transaction issues</li>
        <li>Assistance with mobile app features and updates</li>
        <li>Resetting PIN or password for mobile banking</li>
      </ul>
      <a href="customer_info.php" class="btn-back">Back to Home</a>
    </div>
    
    <div class="col-md-6 table-section">
      <h3 class="mb-4">Mobile Banking Queue</h3>
