...
try {
    $stmt = $pdo->query("SELECT * FROM assistance_queue ORDER BY time_created DESC");
...
<div class="container">
  <div class="row g-4 align-items-start">
    <div class="col-md-6 left-info">
      <h2>Friendly Assistance Service</h2>
      <p><strong>See the queue number</strong> to know your turn in line.</p>
      <p>Services typically provided by our Assistants include:</p>
      <ul>
        <li>Welcoming and guiding customers at the branch</li>
        <li>Providing information about banking services</li>
        <li>Helping customers fill out forms or documents</li>
        <li>Assisting in scheduling appointments with officers</li>
      </ul>
      <a href="customer_info.php" class="btn-back">Back to Home</a>
    </div>
    
    <div class="col-md-6 table-section">
      <h3 class="mb-4">Friendly Assistance Queue</h3>
