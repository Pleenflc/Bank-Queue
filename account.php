...
try {
    $stmt = $pdo->query("SELECT * FROM account_queue ORDER BY time_created DESC");
...
<div class="container">
  <div class="row g-4 align-items-start">
    <div class="col-md-6 left-info">
      <h2>Account Safety Service</h2>
      <p><strong>See the queue number</strong> to know your turn in line.</p>
      <p>Services typically provided by our Account Safety Team include:</p>
      <ul>
        <li>Assistance with suspicious account activity</li>
        <li>Verification of user identity and security checks</li>
        <li>Review and handling of account restrictions or freezes</li>
        <li>Guidance on securing accounts and reporting fraud</li>
      </ul>
      <a href="customer_info.php" class="btn-back">Back to Home</a>
    </div>
    
    <div class="col-md-6 table-section">
      <h3 class="mb-4">Account Safety Queue Data</h3>
