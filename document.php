...
try {
    $stmt = $pdo->query("SELECT * FROM document_queue ORDER BY time_created DESC");
...
<div class="container">
  <div class="row g-4 align-items-start">
    <div class="col-md-6 left-info">
      ...
      <p>Services typically provided by our Document Service Team include:</p>
      <ul>
        <li>Providing account statements and transaction history</li>
        <li>Issuing bank reference letters or certificates</li>
        <li>Processing document verification requests</li>
        <li>Handling requests for printed or digital official documents</li>
      </ul>
      <a href="customer_info.php" class="btn-back">Back to Home</a>
    </div>
    
    <div class="col-md-6 table-section">
      <h3 class="mb-4">Document Service Queue</h3>
