...
try {
    $stmt = $pdo->query("SELECT * FROM teller_queue ORDER BY time_created DESC");
...
<div class="container">
  <div class="row g-4 align-items-start">
    <div class="col-md-6 left-info">
      <h2>Teller Service</h2>
      <p><strong>See the queue number</strong> to know your turn in line.</p>
      <p>Services typically provided by our Tellers include:</p>
      <ul>
        <li>Processing cash deposits and withdrawals</li>
        <li>Accepting check deposits and issuing bank drafts</li>
        <li>Providing account balance information</li>
        <li>Handling money transfers and payments</li>
      </ul>
      <a href="customer_info.php" class="btn-back">Back to Home</a>
    </div>
    
    <div class="col-md-6 table-section">
      <h3 class="mb-4">Teller Queue</h3>
